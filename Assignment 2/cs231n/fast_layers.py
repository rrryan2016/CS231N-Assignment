...
def conv_forward_strides(x, w, b, conv_param):
  ...
  H += 2 * pad
  W += 2 * pad
  out_h = (H - HH) // stride + 1 # Alter Point
  out_w = (W - WW) // stride + 1 # Alter Point
...
def max_pool_forward_reshape(x, pool_param):
  ...
  x_reshaped = x.reshape(N, C, H // pool_height, pool_height, # Alter Point
  # x_reshaped = x.reshape(N, C, H / pool_height, pool_height,
                         W // pool_width, pool_width) # Alter Point
