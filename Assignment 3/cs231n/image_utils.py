import urllib.request, os, tempfile # Alter point
...
def image_from_url(url):
  ...
  """
  try:
    f = urllib.request.urlopen(url) #Alter point
    ...
    return img
  except urllib.request.URLError as e: #Alter point
  # except urllib2.URLError as e:
    print ('URL Error: ', e.reason, url)
  except urllib.request.HTTPError as e: #Alter point
